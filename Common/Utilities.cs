...
namespace Azure.ResourceManager.Samples.Common
{
    public static class Utilities
    {
        ...
        public static VirtualMachineResource CreateVirtualMachine(ResourceGroupResource resourceGroup, ResourceIdentifier subnetId, string vmName = null)
        {
            ...
            var networkInterfaceLro = resourceGroup.GetNetworkInterfaces().CreateOrUpdate(WaitUntil.Completed, nicName, subnetInput);
            ...
            var vmLro = vmCollection.CreateOrUpdate(WaitUntil.Completed, vmName, vmInput);
            return vmLro.Value;
        }
    }
}
